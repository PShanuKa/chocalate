...
const Header = () => {
  return (
    <div
      className="bg-cover w-full h-[234px] sm:h-[312px] lg:h-[548px] flex items-center justify-center"
    ...
    >
      <div className="text-white items-center flex flex-col">
        ...
        <div className="flex gap-6 items-center lg:pt-[30px] pt-[10px]">
            ...
            <div className="flex items-center gap-2"><GoDotFill className="hidden md:block" size={25}/><FaChevronRight className="md:hidden" size={25}/><p className="text-[14px] md:text-[24px]">LOGIN</p></div>
        </div>
      </div>
    </div>
  );
